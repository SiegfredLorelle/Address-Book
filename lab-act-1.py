...
if __name__ == "__main__":
    ...
    # Submit btn
    a_submit_btn = tk.Button(add_contact, text="Add", font=("Arial", 12), bg="#EB6440", command=save_contact)
